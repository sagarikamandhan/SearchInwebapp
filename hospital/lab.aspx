<%@ Page Title="" Language="C#" MasterPageFile="~/nav.master" AutoEventWireup="true" CodeFile="lab.aspx.cs" Inherits="Default2" %>
        ...
        <div class="container-fluid">
            <div class="well">
                <asp:DataList ID="DataList1" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal" RepeatColumns="3" CssClass="hidebr">
                    <HeaderTemplate><center><h1>Laboratory List</h1></center></HeaderTemplate>
                    <ItemTemplate>
                        <div class="col-sm-4">
