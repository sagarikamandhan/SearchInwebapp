...
public partial class Admin_Default2 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (ViewState["aa"] == null)
            {
                ...
                string sa = "insert into state (sname) values ('" + name + "')";
            ...
            {
                string sa = "update state set sname='" + name + "' where sid='" + ViewState["aa"] + "' ";
                cmd = new SqlCommand(sa, con);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                string sa = " delete from state where sid='" + e.CommandArgument + "' ";
                cmd = new SqlCommand(sa, con);
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
            ...
            {
                string sa = "select * from state where sid ='" + e.CommandArgument + "'  ";
                cmd = new SqlCommand(sa, con);
                con.Open();
                ad = new SqlDataAdapter(cmd);
                ad.Fill(ds);
